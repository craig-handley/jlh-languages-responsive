    ...
    footer [ id "footer" ]
        [ div [ class "inner" ]
            [ div [ class "flex" ]
                ...
                , ul [ class "icons" ]
                    [ li [] [ a [ href "https://www.facebook.com/JLHLanguages/", class "icon fab fa-facebook-square", target "_blank" ] [] ]
                    , li [] [ text "Find us on Facebook" ]
                    , li [] [ a [ href "mailto:jane@jlhlanguages.org", class "icon fas fa-envelope", target "_blank" ] [] ]
                    , li [] [ text "jane@jlhlanguages.org" ]
                    , li [ class "icon fas fa-phone-square", style "color" "#5385c1" ] []
                    , li [] [ text "07793 556020" ]
                    ]
                ]
            ]
        ]
