module Pages.AdultCoursesSpanish exposing (Model, Msg(..), init, update, view)
        ...
        [ section [ id "three", class "wrapper special" ]
            [ div [ class "inner" ]
                [ header [ class "align-center" ]
                    [ h2 [] [ text "Spanish Adult Courses" ]

                    --, p [] [ text "Aliquam erat volutpat nam dui " ]
                    ]
                , h3 [ style "color" "red" ]
                    [ p [] [ text "We are currently in the process of setting up our Spanish classes. For more information and to express an interest in these lessons please get in touch at:" ]
                    , p [] [ text "fliss@jlhlanguages.org / 07967 653035." ]
                    , p [] [ text "Face-to-face or Zoom lessons are scheduled to begin from September 2020." ]
                    ]

                -- , h3 [ style "color" "red" ] [ text "Unfortunately due to Coronavirus our face-to-face lessons are currently suspended. However lessons continue to take place online. Please email fliss@jlhlanguages.org for details." ]
                ...
                -- , div [ class "flex flex-1" ]
                --     [ article []
                --         [ p [] [ text "* Advanced Conversation: For fluent or near-fluent speakers of Spanish. Come along and chat or discuss the issues of the day." ]
                --         , p [] [ text "** Improvers: Learners have a sound grasp of Spanish grammar and want to improve their spoken Spanish in order to communicate effectively in the language." ]
                --         , p [] [ text "First session free." ]
                --         , p [] [ text "If you are interested in attending a course at any of these locations please get in touch (fliss@jlhlanguages.org / 07793 556020) stating the venue(s) of interest and the relevant Spanish course (beginner / mixed ability / intermediate / advanced.)" ]
                ...
                , div [ class "flex flex-1" ]
                    [ article []
                        ...
                        , p [] [ text "Regular tips of how to learn and links to useful websites/TV or radio programmes that may be of interest to learners of Spanish." ]
                        ]
                    ]
                , div [ class "flex flex-1" ]
                    [ article []
